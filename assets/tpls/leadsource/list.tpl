<div class="panel panel-default">
    <div class="panel-heading" style='height:50px'>
        ...
        <div class="pull-right">
            <button class="btn btn-primary" ng-click='create()'>New Lead Source Type</button>
        </div>
    </div>
    ...
    <script type='text/ng-template' id='lead-form.html'>

        <div class="modal-header">
            <button type="button" class="close" ng-click='close()' aria-hidden="true">&times;</button>
            <h4 class="modal-title"><span ng-show='lead.id'>Edit</span><span ng-hide='lead.id'>New</span> Lead Source Type</h4>
        </div>
        ...
        <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" class="form-control" ng-model='lead.label' required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-12">
