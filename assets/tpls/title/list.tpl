<div class="panel panel-default">
    <div class="panel-heading" style='height:50px'>
        ...
        <div class="pull-right">
            <button class="btn btn-primary" ng-click='create()'>New Title</button>
        </div>
    </div>
    ...
    <script type='text/ng-template' id='title-form.html'>

        <div class="modal-header">
            <button type="button" class="close" ng-click='close()' aria-hidden="true">&times;</button>
            <h4 class="modal-title"><span ng-show='title.id'>Edit</span><span ng-hide='title.id'>New</span> Title</h4>
        </div>
        ...
        <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" class="form-control" ng-model='title.label' required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-12">
