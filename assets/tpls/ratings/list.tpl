<div class="panel panel-default">
    <div class="panel-heading" style='height:50px'>
        ...
        <div class="pull-right">
            <button class="btn btn-primary" ng-click='create()'>New Rating Type</button>
        </div>
    </div>
    ...
    <script type='text/ng-template' id='rating-form.html'>
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title"><span ng-show='lead.id'>Edit</span><span ng-hide='lead.id'>New</span> Rating Type</h4>
        </div>
        ...
        <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" class="form-control" ng-model='rating.label' required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-12">
